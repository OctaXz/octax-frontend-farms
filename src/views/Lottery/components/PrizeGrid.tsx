...
const PrizeGrid: React.FC<PrizeGridProps> = ({
  ...
  const fourMatchesAmount = +((lotteryPrizeAmount / 100) * 60).toFixed(3)
  const threeMatchesAmount = +((lotteryPrizeAmount / 100) * 20).toFixed(3)
  const twoMatchesAmount = +((lotteryPrizeAmount / 100) * 10).toFixed(3)
  const burnAmount = +((lotteryPrizeAmount / 100) * 10).toFixed(3)
